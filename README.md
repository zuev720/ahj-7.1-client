...
![](https://github.com/netology-code/ahj-homeworks/blob/simplification/http/pic/helpdesk.png)

Модальное окно добавления нового тикета (вызывается по кнопке "Добавить тикет" в правом верхнем углу):

![](https://github.com/netology-code/ahj-homeworks/blob/simplification/http/pic/helpdesk-2.png)

Модальное окно редактирования существующего тикета (вызвается по кнопке с иконкой "✎" - карандашик):

![](https://github.com/netology-code/ahj-homeworks/blob/simplification/http/pic/helpdesk-3.png)

Модальное окно подтверждения удаления (вызывается по кнопке с иконкой "x" - крестик):

![](https://github.com/netology-code/ahj-homeworks/blob/simplification/http/pic/helpdesk-4.png)

Для просмотра деталей тикета нужно нажать на самом тикете (но не на контролах - сделано, редактировать или удалить):

![](https://github.com/netology-code/ahj-homeworks/blob/simplification/http/pic/helpdesk-5.png)
